...
import ru.supratiztagam.supratiztagam.Events.ErrorEvent;
import ru.supratiztagam.supratiztagam.Events.ServerEvent;
...
public class Communicator {
    ...
    public void getMVersionPost(String ownmversion)
    {
        HttpLoggingInterceptor logging = new HttpLoggingInterceptor();
        logging.setLevel(HttpLoggingInterceptor.Level.BODY);
        OkHttpClient.Builder httpClient = new OkHttpClient.Builder();
        ...
        Call<ServerResponse> call = service.post("getamversion",ownmversion);
